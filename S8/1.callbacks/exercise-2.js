// Usa el siguiente código como base y crea 3 funciones llamadas confirmExample, promptExample y father. 
// La función confirmExample recibirá una variable de tipo string (description) que mostrará 
// como titulo de la ventana y retornará el valor del confirm. 
...
return callback(confirmExample, propmt)
}

console.log(father('hola', confirmExample));
console.log(father('hola', promptExample));
