...
let found$$ = aliens.find((alien) => alien.name === 'Cucushumushu' );
let mutation$$ = mutations.find((mutation) => mutation.name === 'Porompompero' );

const {name:mutacion, description} = mutation$$

const perfectAlien = {...found$$, mutacion, description};

console.log(perfectAlien)
